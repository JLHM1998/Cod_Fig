...
for i, tratamiento in enumerate(tratamientos):
    ...
    if i == 0:
        ax.set_ylabel('ETc (mm d$^{-1}$)')  # Etiqueta del eje Y solo en el primer gráfico
    else:
    ...
    # Establecer límite en el eje X de 1 a 14
...
plt.savefig('grafico_Etc.png', dpi=600, format='png', bbox_inches='tight')
